	...
	<div id="container" class="gridsystem cf">
		<div class="container-wrap cf">
			...
			<section class="grid-4 fr">
				<div class="subbanner">
					<img class="top_img" src="/resources/template/images/guijinshuxueyuan.jpg" alt="在线咨询" />
				</div>
			    	...
			    	<div class="sub-news new-cont bd cf">
			    		<div class="new-zy">
			    			<div class="new-topwrap cf">
								...
								<div class="new-zycont"><?php echo mb_strimwidth($news['outline'], 0, 265, "...", "utf8");?><span>[2013-5-27 9:59:24]</span> <a class="gary" title="<?php echo $news['title'];?>" href="/news/xyshow/<?php echo $news['id'];?>">全文</a> 
						            </div>
					            </div>
				            </div>
