	...
	<div id="container" class="gridsystem cf">
		<div class="container-wrap cf">
			...
			<section class="grid-4 fr">
				...
				<div class="crumbs">
					本页位置：<a href="/">首页</a><span>&gt;&gt;</span><a href="/item/show/online_userform">在线咨询</a><span>&gt;&gt;</span><?php echo $article['typename'];?>
	            </div>
	            ...
	            <div class="details-wrap">
					...
					<?php 
						...
						{
							?>
								<p>上一篇：<a href="/news/wtshow/<?php echo $pre['id'];?>"><?php echo $pre['title']?></a></p>
					...
					<?php 
						...
						{
							?>
								<p>下一篇：<a href="/news/wtshow/<?php echo $next['id'];?>"><?php echo $next['title']?></a></p>
