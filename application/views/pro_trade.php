	...
	<div id="container" class="gridsystem cf">
		<div class="container-wrap cf">
			...
			<section class="grid-1 fl">
				<div class="topmenu">
					<dl>
						...
						<dd class="active"><a href="pro-trade.html">交易细则</a></dd>
			...
			<section class="grid-4 fr">
				...
				<div class="crumbs">
	            	本页位置：<a href="index.html">首页</a><span>&gt;&gt;</span><a href="products.html">产品介绍</a><span>&gt;&gt;</span>交易细则 
	            </div>
				...
				<div class="mod3">
					...
					<div class="content-wrap pro-trade">
						<ul class="news-list2">
							<li class="cf">
								<div class="pic-news">
						...
						<p>未经过休市结算的新激活客户，以激活前的客户权益确定其试用的建仓保证金比例以及合约建仓权限</p>
					</div>
		        </div>
			</section><!-- /content -->
