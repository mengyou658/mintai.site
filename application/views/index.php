...
<div id="container" class="gridsystem cf">
	...
	<div class="cf">
		...
		<section class="grid-1 fl">
			...
			<div class="mb-12">
				<a href="/item/show/robot"><img src="/resources/template/images/ads/jiqiren.jpg" alt="华尔街算法机器人喊单" title="华尔街算法机器人喊单" /></a>
			</div>
		</section>
				    		...
				    		<div class="new-zy">
				    			<div class="new-topwrap cf">
							     ...
							     <?php 
									...
									{
										?>
											<h2><a title="<?php echo $article9['title']?>" href="/news/xyshow/<?php echo $article9['id'];?>"><?php echo $article9['title'];?></a></h2>
											<div class="new-zycont"><?php echo mb_strimwidth($article9['outline'], 0, 90, "...", "utf8");?><span>[<?php echo $article9['sp_date']?>]</span> <a title="<?php echo $article9['title'];?>" href="/news/xyshow/<?php echo $article9['id'];?>">全文</a> 
									</div>
				    		...
				    		<div class="new-zy">
				    			<div class="new-topwrap cf">
							     ...
							     <?php 
									...
									{
										?>
											<h2><a title="<?php echo $article10['title']?>" href="/news/xyshow/<?php echo $article10['id'];?>"><?php echo $article10['title'];?></a></h2>
											<div class="new-zycont"><?php echo  mb_strimwidth($article10['outline'], 0, 90, "...", "utf8");?><span>[<?php echo $article10['sp_date']?>]</span> <a title="<?php echo $article10['title'];?>" href="/news/xyshow/<?php echo $article10['id'];?>">全文</a> 
									</div>
				    	...
				    	<div class="new-cont bd cf">
				    		<div class="new-zy">
							    ...
							    <?php 
									...
									{
										?>
											<h2><a title="<?php echo $article11['title']?>" href="/news/xyshow/<?php echo $article11['id'];?>"><?php echo $article11['title'];?></a></h2>
											<div class="new-zycont"><?php echo mb_strimwidth($article11['outline'], 0, 90, "...", "utf8");?><span>[<?php echo $article11['sp_date']?>]</span> <a title="<?php echo $article11['title'];?>" href="/news/xyshow/<?php echo $article11['id'];?>">全文</a> 
									</div>
				    	...
				    	<div class="new-cont bd cf">
				    		<div class="new-zy">
							    ...
							    <?php 
									...
									{
										?>
											<h2><a title="<?php echo $article12['title']?>" href="/news/xyshow/<?php echo $article12['id'];?>"><?php echo $article12['title'];?></a></h2>
											<div class="new-zycont"><?php echo mb_strimwidth($article12['outline'], 0, 90, "...", "utf8");?><span>[<?php echo $article12['sp_date']?>]</span> <a title="<?php echo $article12['title'];?>" href="/news/xyshow/<?php echo $article12['id'];?>">全文</a> 
									</div>
						...
						<div class="items">
							...
							<div>
								...
								<div class="item">
									<dl>
								       <dd>
										   <span class="dd-img"><a href="ttp://www.mintai166.com/web/Deal.aspx" target="_blank" title="农业银行网上签约"><img src="/resources/template/images/nonghang_pic.jpg" alt="农业银行网上签约" title="农业银行网上签约"  /></a></span>
									    </dd>
									    <dt>
