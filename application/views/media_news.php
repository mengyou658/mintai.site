		...
		<div class="container-wrap cf">
			...
			<section class="grid-1 fl">
				<div class="topmenu">
					<dl>
						<dt>媒体报道</dt>
						<dd class="active"><a href="/news/media_news">媒体报道</a></dd>
					</dl>
				</div>
			...
			<section class="grid-4 fr">
				...
				<div class="crumbs">
	            	本页位置：<a href="/">首页</a><span>&gt;&gt;</span><a href="/news/media_news">媒体报道</a><span>&gt;&gt;</span>媒体报道 
	            </div>
				            ...
				            <ul class="news-list">
								<?php
									if(!empty($articles))	
									{
										...
										{
											?>
												<li><span><?php echo $article['post_time']?></span><a title="<?php echo $article['title'];?>" target="_blank" href="/news/mdshow/<?php echo $article['id']?>"><?php echo $article['title']?></a></li>
											<?php
										}
									}
								?>
